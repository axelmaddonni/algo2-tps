...
\section{Estructura Arbol Binario ($\alpha, \sigma$) }
\input{AB}

\clearpage

\section{Módulo Cola de Prioridad Logaritmica ($\alpha$) }
\input{Heap}

\clearpage

\section{Módulo Diccionario Universal ($\sigma$) }
\input{Trie}

\clearpage

\section{Módulo Diccionario Logaritmico ($\kappa$, $\sigma$) }
\input{AVL}
