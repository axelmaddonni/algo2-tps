...
\Function{iAgregarCompu}{inout r: estr\_red, in c1: compu}{}
	...
	\State DefinirRapido(r, c1.ip, tupla(c1.interfaces, nuevoDiccVacio, nuevoDiccVacio)) \Comment{O(Copiar(sL)) con sL=string de largo L}
\EndFunction \Comment{\textbf{O(L)}}
\end{algorithmic}
\end{algorithm}
