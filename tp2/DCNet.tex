...
\begin{Tupla}[estr\_dcnet]
	\tupItem{red}{red} \newline \nomoreitems
	\tupItem{todos}{conj(X)} \newline \nomoreitems
	\tupItem{porHostname}{dicc$_{TRIE}$ (hostname, itConj(X))} \newline \nomoreitems
	\tupItem{conMasEnvios}{itConj(X)} \newline \nomoreitems
	\tupItem{proxDest}{arreglo\_dimensionable de arreglo\_dimens. de lista(compu)} \nomoreitems
\end{Tupla}

\begin{Tupla}[X]
	\tupItem{compu}{hostname} \newline \nomoreitems
	\tupItem{indice}{nat} \newline \nomoreitems
